...
<p class="field">
    ...
    <input type="text" id="${currentNode.name}" name="${currentNode.name}" value="${not empty sessionScope.formError and param['ec'] eq form.identifier ? sessionScope.formDatas[currentNode.name][0] : ''}"/>
</p>